 ...
 */
class Emailtype extends \Fluxuser\Entity\Emailtype implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Fluxuser\\Entity\\Emailtype' . "\0" . 'id', '' . "\0" . 'Fluxuser\\Entity\\Emailtype' . "\0" . 'emailtype');
        }
