 ...
 */
class Systemaccount extends \Fluxuser\Entity\Systemaccount implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Fluxuser\\Entity\\Systemaccount' . "\0" . 'accountid', '' . "\0" . 'Fluxuser\\Entity\\Systemaccount' . "\0" . 'customer', '' . "\0" . 'Fluxuser\\Entity\\Systemaccount' . "\0" . 'customerid', '' . "\0" . 'Fluxuser\\Entity\\Systemaccount' . "\0" . 'active', '' . "\0" . 'Fluxuser\\Entity\\Systemaccount' . "\0" . 'state', '' . "\0" . 'Fluxuser\\Entity\\Systemaccount' . "\0" . 'description');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Systemaccount $proxy) {
